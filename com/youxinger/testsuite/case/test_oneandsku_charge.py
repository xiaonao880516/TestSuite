...
class TestGeneralGoods(BaseCase):
    ...
    def test_1_sku_charge_order(self):
        """
        charge下单
        ...
        :return:
        """
        logging.debug("test_1_sku_charge_order")
        recharge_param = {'price': '19560.00', 'discount_money': '782.40', 'real_pay': '18777.60',
                          ...
                          'pay_type': 'recharge'}
        # 下单购物
        globals()['shopping_order_id'] = market_service.recharge_order(recharge_param)
        # 更新充值后的验证数据
    ...
    def test_2_changer_some(self):
        """
        换货2件商品数据
        腰背夹M216C237，深蓝色，58 换2个 腰背夹M216C237C0464， 深蓝色，64
        :return:
        """
        logging.debug("test_2_changer_some")
    ...
    def test_3_return_some(self):
        ...
        return_param = {'main_order_id': shopping_order_id, 'return_price':'12288.00', 'reason': '拍错/不想要', 'remarks': 'gg', 'afterSales_info[0][order_id]': return_order_id2, 'afterSales_info[0][danjia]': '6400.00',
                        ...
                        'afterSales_info[0][aftersale_money]': '6144.00', 'afterSales_info[0][goods_type]': '2', 'afterSales_info[1][order_id]':return_order_id1, 'afterSales_info[1][danjia]': '6400.00',
    ...
    def test_5_return_other(self):
        ...
        :return:
        """
        logging.debug("test_5_return_other")
        shopping_order_id = globals()['shopping_order_id']
        member_number = self._customer.member_number
        ...
        self._test_data.update_post_verify_data()
        # 验证值
        self.expectedData(-6489.60 # 会员消费额
                              , 0 # 会员积分
                              , 2 # 会员卡等级
                              , 6489.60 # 会员余额
                              , 0 # 总揽到店次数
