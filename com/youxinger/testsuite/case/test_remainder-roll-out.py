...
from com.youxinger.testsuite.utils.constant import TRANSFER_PHONE
...
class TestCashWithdrawal(BaseCase):
    ...
    def setUp(self):
        ...
        self._test_data_cu.update_pre_verify_data()
    ...
    def test_1_recharge_shopping_order(self):
        ...
        self._test_data_cu.update_post_verify_data()
        # 封装验证值
        self._customer_re.expectedData = CustomerVerifyData.expected_data(0, 0, 0, -100)  # 更新会员验证值
        self._customer_cu.expectedData = CustomerVerifyData.expected_data(0, 0, 0, 100)  # 更新会员验证值
        # 验证数据
        self._data_assertion_re()
        self._data_assertion_cu()
