...
class TestSpecialGoods(BaseCase):
    """
     pos方式门店总仓混合下单测试
    """
    ...
    def test_1_recharge_shopping_order(self):
        ...
        recharge_param = {'price': '19200.00', 'discount_money': '768.00', 'real_pay': '18432.00',
                          ...
                          'goods_list[2][tiaoma]': 'M216C237C0458',
                          ...
                          'goods_list[4][tiaoma]': 'M216C237C0458',
                          ...
                          'goods_list[5][zh_no_score]': '0', 'pay_type': 'pos'
