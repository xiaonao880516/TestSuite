   ...
   组合商品与普通商品
    ...
    def test_2_pos_Combination_and_common_exchange_part(self):
        ...
        if globals()['shopping_order_id'] is not None:
            ...
            pos_param = {'sub_order_id': exchange_order_id, 'goods_num': '1', 'goods_total_price': '3244.80', 'reason': '30天无理由换货', 'remarks': '哈哈', 'type': '2',
    ...
    def test_4_Combination_and_common_return_other(self):
        ...
        if globals()['shopping_order_id'] is not None:
            ...
            return_other = {'main_order_id': globals()['shopping_order_id'], 'return_price': '15532.80',
