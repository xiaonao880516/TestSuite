...
class TestGeneralGoods(BaseCase):
    ...
    def test_1_sku_post_order(self):
        """
        pos下单
        ZH02B215190T796242   4件
        其中2件选择 深蓝色 58 和黑色 58
            2件选择 深蓝色 64 和黑色 64
        :return:
        """
        logging.debug("test_1_sku_post_order")
        recharge_param = {'price': '25600.00', 'discount_money': '1024.00', 'real_pay': '24576.00',
                          ...
                          'goods_list[4][sku_id]': '4879',
                          'goods_list[4][tiaoma]': 'M216C237C0464', 'goods_list[4][kuanhao]': 'M216C237',
                          'goods_list[4][sku_detail]': '深蓝色 64',
                          ...
                          'goods_list[5][sku_id]': '4702',
                          'goods_list[5][tiaoma]': 'M116E248B0164', 'goods_list[5][kuanhao]': 'M116E248',
                          'goods_list[5][sku_detail]': '黑色 64',
                          ...
                          'goods_list[6][sku_id]': '4879',
                          'goods_list[6][tiaoma]': 'M216C237C0464', 'goods_list[6][kuanhao]': 'M216C237',
                          'goods_list[6][sku_detail]': '深蓝色 64',
                          ...
                          'goods_list[7][sku_id]': '4702',
                          'goods_list[7][tiaoma]': 'M116E248B0164', 'goods_list[7][kuanhao]': 'M116E248',
                          'goods_list[7][sku_detail]': '黑色 64',
        ...
        # 验证值
        self.expectedData(24576.00  # 会员消费额
                          , 24576.00  # 会员积分
                          , 3  # 会员卡等级
                          , 0  # 会员余额
                          , 1  # 总揽到店次数
    ...
    def test_2_return_all(self):
        ...
        if globals()['shopping_order_id'] is not None:
            ...
            return_param = {'main_order_id': globals()['shopping_order_id'], 'return_price': '24576.00', 'reason': '拍错/不想要', 'remarks': '萨范德',
                            'afterSales_info[0][order_id]': return_order_id0, 'afterSales_info[0][danjia]': '6400.00', 'afterSales_info[0][sku_name]': '孟伟组合商品',
                            'afterSales_info[0][sku_detail]': '2件商品', 'afterSales_info[0][tiaoma]': 'ZH02B215190T796242', 'afterSales_info[0][kuanhao]': '', 'afterSales_info[0][sku_id]': '5955',
                            ...
                            'afterSales_info[1][order_id]': return_order_id1, 'afterSales_info[1][danjia]': '6400.00',
                            ...
                            'afterSales_info[1][sku_id]': '5955', 'afterSales_info[1][img]': 'https://lchapp.oss-cn-beijing.aliyuncs.com/2019080310765489321.jpg',
                            'afterSales_info[1][aftersale_num]': '1', 'afterSales_info[1][aftersale_money]': '6144.00', 'afterSales_info[1][goods_type]': '2',
